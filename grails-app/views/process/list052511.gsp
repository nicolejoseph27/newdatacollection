...
<style type="text/css">
	...
	var boxSizeArray = [8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8];	// Array indicating how many items there is rooom for in the right column ULs
	...
	*/
	...
	<div id="dhtmlgoodies_mainContainer">
		...
		<div>
			<p><g:link action="show" id="${processInstance.id}">${fieldValue(bean: processInstance, field: "id")}</g:link>
			${fieldValue(bean: processInstance, field: "canister")}
			</p>
			<ul id="box1"></ul>
		</div>
		</g:each>
