   ...
   <g:javascript plugin="jquery-ui-extensions" library="jquery-extensions" />
    ...
    <body>
        ...
        <div class="body" style="width:85%">
            <h1><g:message code="Job Duration"/></h1>
                ...
                <table>
                    <thead>
                        <tr>
                            ...
                            <g:sortableColumn style="text-align:center" property="jobStartDate" title="${message(code: 'job.jobStartDate.label', default: 'Job Start Date')}" />
                    ...
                    <g:each in="${jobInstanceList}" status="i" var="jobInstance">
                        <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
                            ...
                            <td style="text-align:center">${fieldValue(bean: jobInstance, field: "jobStartDate")}</td>
