...
<%@ page import="com.magnetboard.UserRole" %>
<html>
    <head>
                        ...
                        <tbody>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: userRoleInstance, field: 'role', 'errors')}">
                                    <g:select name="role.id" from="${com.magnetboard.Role.list()}" optionKey="id" value="${userRoleInstance?.role?.id}"  />
                                </td>
                            </tr>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: userRoleInstance, field: 'user', 'errors')}">
                                    <g:select name="user.id" from="${com.magnetboard.User.list()}" optionKey="id" value="${userRoleInstance?.user?.id}"  />
                                </td>
                            </tr>
