                ...
                <div class="dialog">
                    <table>
                        <tbody>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="prePregPartNumbers"><g:message code="material.prePregPartNumbers.label" default="Pre Preg Part Numbers" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: materialInstance, field: 'prePregPartNumbers', 'errors')}">
                                    <g:select name="prePregPartNumbers" from="${magnetboard.PrePregPartNumber.list()}" multiple="yes" optionKey="id" size="5" value="${materialInstance?.prePregPartNumbers*.id}" />
                                </td>
                            </tr>
